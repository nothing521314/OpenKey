...
- (void)viewDidLoad {
    ...
    CGColorRef bgColor = [NSColor windowBackgroundColor].CGColor;

    for (NSButton* b in tabbuttons) {
        b.wantsLayer = YES;
        b.layer.backgroundColor = bgColor;
        b.layer.cornerRadius = 4.0;

        b.layer.shadowColor = [NSColor blackColor].CGColor;
        b.layer.shadowOffset = CGSizeMake(0, 2);
        b.layer.shadowOpacity = 0.2;
        b.layer.shadowRadius = 2.0;

        b.layer.zPosition = 1.0;
